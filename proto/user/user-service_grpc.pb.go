...
type UserServiceClient interface {
	...
	GetContacts(ctx context.Context, in *GetContactsRequest, opts ...grpc.CallOption) (UserService_GetContactsClient, error)
}
...
func (c *userServiceClient) DeleteContact(ctx context.Context, in *DeleteContactRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/user_service.UserService/DeleteContact", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) GetContacts(ctx context.Context, in *GetContactsRequest, opts ...grpc.CallOption) (UserService_GetContactsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_UserService_serviceDesc.Streams[0], "/user_service.UserService/GetContacts", opts...)
	if err != nil {
		return nil, err
	}
	x := &userServiceGetContactsClient{stream}
...
type UserService_GetContactsClient interface {
	Recv() (*GetContactResponse, error)
	grpc.ClientStream
}

type userServiceGetContactsClient struct {
	grpc.ClientStream
}

func (x *userServiceGetContactsClient) Recv() (*GetContactResponse, error) {
	m := new(GetContactResponse)
...
type UserServiceServer interface {
	...
	GetContacts(*GetContactsRequest, UserService_GetContactsServer) error
...
func (UnimplementedUserServiceServer) GetContacts(*GetContactsRequest, UserService_GetContactsServer) error {
...
func _UserService_DeleteContact_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user_service.UserService/DeleteContact",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserService_GetContacts_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(UserServiceServer).GetContacts(m, &userServiceGetContactsServer{stream})
}

type UserService_GetContactsServer interface {
	Send(*GetContactResponse) error
	grpc.ServerStream
}

type userServiceGetContactsServer struct {
	grpc.ServerStream
}

func (x *userServiceGetContactsServer) Send(m *GetContactResponse) error {
